...
<html lang = "pl-PL">
    ...
    <body>
        ...
        <section>
            <p id = "bread"><a href = "../index.html">Strona główna</a> > <a href = "../man.php">Perfumy męskie</a> > <?= htmlspecialchars($product_breadcrumb) ?></p>
            ...
            <div class = "descProduct" id = "slider">
                ...
                <img class = "productPhoto" src = "../../parfums/man/M_Dior_Fahrenheit_2.png"/>
                <img class = "productPhoto" src = "../../parfums/man/M_Dior_Fahrenheit_3.png"/>
                <script>
                    function slider(){
