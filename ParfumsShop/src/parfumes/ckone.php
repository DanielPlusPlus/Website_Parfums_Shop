...
<html lang = "pl-PL">
    ...
    <body>
        ...
        <section>
            <p id = "bread"><a href = "../index.html">Strona główna</a> > <a href = "../man.php">Perfumy uniseks</a> > <?= htmlspecialchars($product_breadcrumb) ?></p>
            ...
            <div class = "descProduct" id = "slider">
                ...
                <img class = "productPhoto" src = "../../parfums/unisex/U_CalvinKlein_CKOne_2.png"/>
                <img class = "productPhoto" src = "../../parfums/unisex/U_CalvinKlein_CKOne_3.png"/>
                <script>
                    function slider(){
                        const img = document.getElementsByClassName("productPhoto");
                        for (let i = 0; i < img.length; i++) {
                            img[i].style.display = "none";
                        }
                        if (photoNb >= img.length) {
                            photoNb = 0;
                        }
                        img[photoNb].style.display = "block";
                        photoNb++;
